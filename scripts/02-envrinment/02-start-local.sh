...
echo ""
echo "⭐ 주요 기능:"
echo "   • 메모 빠른 저장: POST /v1/api/memo/quick-save"
echo "   • 메모 AI 정제: POST /v1/api/memo/refine" 
echo "   • 조건부 분석: POST /v1/api/memo/analyze"
echo "   • 고객 생성: POST /v1/api/customer/create"
echo "   • 엑셀 업로드: POST /v1/api/customer/excel-upload"
echo "   • 컬럼 매핑: POST /v1/api/customer/column-mapping"
echo ""
echo "🆕 LCEL SQL 파이프라인:"
echo "   • SQL 생성: POST /v1/api/lcel-sql/generate"
echo "   • 스트리밍 SQL: POST /v1/api/lcel-sql/generate-streaming"
echo "   • SQL 실행: POST /v1/api/lcel-sql/execute-and-run"
echo "   • 전략 목록: GET /v1/api/lcel-sql/strategies"
echo ""
echo "🔍 자연어 검색 API:"
echo "   • 자연어 검색: POST /v1/api/search/natural-language"
echo "   • 실시간 스트림: WS /ws/search/stream"
echo "   • 검색 전략: GET /v1/api/search/strategies"
echo "   • 상태 확인: GET /v1/api/search/health"
echo ""
echo "🛑 서버 중지: Ctrl+C"
echo "=================================================="
